class GLManager {
    // This just makes the GL Api a bit more class-based and convenient to use.
    ...
    addElementArrayBufferData = (vertices) => this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(vertices), this.gl. STATIC_DRAW);
